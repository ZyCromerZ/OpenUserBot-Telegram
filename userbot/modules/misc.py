...
async def creator(e):
    await e.edit("[ZyCromerZ](https://t.me/ZyCromerZ)")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[OpenUserBot's README.md file](https://github.com/ZyCromerZ/OpenUserBot-Telegram/blob/master/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "Click [here](https://github.com/ZyCromerZ/OpenUserBot-Telegram) to open my userbot GitHub page."
    )
