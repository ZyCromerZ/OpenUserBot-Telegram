...
cd
git clone https://github.com/ZyCromerZ/OpenUserBot-Telegram.git
cd OpenUserBot
git remote set-url origin https://${GH_USERNAME}:${GH_PERSONAL_TOKEN}github.com/ZyCromerZ/OpenUserBot-Telegram.git
git fetch
